:::tracker{species="Squirtle" baseStats="[[44, 48, 65, 50, 64, 43], [59, 63, 80, 65, 80, 58], [79, 83, 100, 85, 105, 78]]" type="Water" generation=3 directInput=true}
  5:
    ...
    45 ->	18, 27, 44, 28, 9, 70
    46 ->	18, 30, 47, 31, 9, 70
    47 ->	23, 32, 48, 33, 10, 70
    48 ->	23, 37, 48, 37, 12, 71
    49 ->	28, 37, 54, 37, 12, 71
    50 ->	31, 40, 55, 37, 12, 76
    51 ->	31, 43, 56, 39, 13, 76
    52 ->	31, 43, 59, 44, 15, 76
    53 ->	33, 48, 59, 44, 17, 76
    54 ->	33, 50, 62, 47, 17, 78
    55 ->	33, 56, 62, 52, 17, 79
    56 ->	33, 59, 62, 54, 18, 83
    57 ->	33, 65, 62, 57, 18, 83
:::

## Pokémon FireRed/LeafGreen Any% WR Route
Prepared by Thunder and Truely
...
Credits for these notes:
  - Thunder for making the original route and Truely for updating it
  - Everyone else involved in the routing process
...
Download the RNG Manip program and set the following IV restrictions:
  ...
  - Sp. Def: 5 / x / X
  - Spe: x / 21 / x
  - Go with 22+attack Modest and 26+ defense mild if going for top time
...
![](https://cdn.discordapp.com/attachments/917309676717244436/1094302194980892823/Antidote_HP.png)
...
Grab this Persim Berry if the chart below says to “Grab Persim” 
...
![](https://cdn.discordapp.com/attachments/917309676717244436/1094303887395147886/Moon_Trainers.png.png)

::variable{name="fight" type="select" title="Which trainer will you fight?" options='["Robby", "Josh", "Grunt"]'}
...
![](https://cdn.discordapp.com/attachments/917309676717244436/1043882409055236096/Bottom_Hiker.png)
...
:::::trainer[Rocket Grunt]
  :::pokemon[Raticate]
    - Mega Kick/Water Pulse*
  ::damage[Raticate's Quick Attack]{source="Squirtle" offensive=false movePower=40 level=32 evolution=1 opponentLevel=20 opponentStat=37 special=false stab=true type=normal}
  :::
  :::pokemon[Zubat]
    - Water Pulse
  :::
...
![](https://cdn.discordapp.com/attachments/917309676717244436/1039520683773919242/BlackGlasses.png)
...
Grab this Rare Candy after fighting the lift key guy
...
:::if{source="Squirtle" condition="$fight == 'Josh'"}
    Subtract 1 Defense IV to your squirtle to get accurate calcs of Kangaskhan's Mega Punch and Quick Attack
    (increase it back after fighting Giovanni)
:::

Before fighting Giovanni:-
- Rare Candy x2 to Level 36
- Heal out of Mega Punch range
...
:::::trainer[Giovanni 1]
  ...
  :::pokemon[Kangaskhan]
    ...
    ::damage[Kangaskhan's Mega Punch]{source="Squirtle" offensive=false movePower=80 level=36 evolution=2 opponentLevel=29 opponentStat=68 combatStages=0 special=false stab=true type=normal}
    ::damage[Kangaskhan's Mega Punch (-1 Defense)]{source="Squirtle" offensive=false movePower=80 level=36 evolution=2 opponentLevel=29 opponentStat=68 combatStages=-1 special=false stab=true type=normal}
  :::
:::::
...
- 6 X Speeds(5 if faster than Blaine and 4 if faster than Sabrina too)	(vv)           
- 21 X Specials (v)	
- 5 X Accuracy (v)
- 2 Guard Specs (v)
...
- 1 X Attack
- 6 X Speeds(5 if faster than Blaine and 4 if faster than Sabrina too)	(vv)   
- 17 X Specials(18 if bought 4/5 X Speeds) (v)
- 5 X Accuracy (v)
- 3 Guard Specs. (v)
...
After obtaining fly:
- Teach Fly to bird
- Heal to around 42 HP
- Super Repel
- Equip Black Glasses
- Toss Moon Stone (makes for faster scrolling up and down in the menus)
- Scroll to Guard Spec/X Special depending on the strat
- Fly to Lavender Town

**Rival 4 X-Attack Strat:**

**If 2 Kicks always kick Ivysaur and Gyarados and Water Pulse, Water Gun Pidgeotto and Growlithe respectively**

:::::trainer[Rival 4]
  :::pokemon[Pidgeotto]
    - Guard Spec, X Acc, X Attack, Water Pulse*/Mega Kick
    ::damage[Pidgeotto's Quick Attack]{source="Squirtle" offensive=false movePower=40 level=36 evolution=2 opponentLevel=25 opponentStat=38 special=false stab=true type=normal}
  :::
  :::pokemon[Ivysaur]
    - Mega Kick
  :::
  :::pokemon[Gyarados]
    ...
    ::damage[Gyarados's Thrash]{source="Squirtle" offensive=false movePower=90 level=36 evolution=2 opponentLevel=23 opponentStat=65 special=false stab=false type=normal}
  :::
  :::pokemon[Growlithe]
    - Mega Kick/Water Pulse
  :::
...
:::::trainer[Rival 4]
  ...
  :::pokemon[Ivysaur]
    - Water Pulse*/Bite (x2)
    ::damage[Ivysaur's Razor Leaf]{source="Squirtle" offensive=false movePower=55 level=36 evolution=2 opponentLevel=25 opponentStat=42 special=true stab=true type=grass}
    :::if{source="Squirtle" condition="spatk=(x / x / 28-29)"}
    - Bite is a 62.5% to OHKO at +2
    - Water Pulse* is a 68.75% to OHKO at +2
    :::
    :::if{source="Squirtle" condition="spatk=(x / x / 30-31)"}
    - Bite is a 68.75% to OHKO at +2
    - Water Pulse* is a 81.25% to OHKO at +2
  :::
  :::pokemon[Gyarados]
    - Bite x2
    ::damage[Gyarados's Thrash]{source="Squirtle" offensive=false movePower=90 level=36 evolution=2 opponentLevel=23 opponentStat=65 special=false stab=false type=normal}
...
**Backup X-Accuracy South of the staircase one floor above the Haunter Lady(if you used it on Rival)**

![](https://cdn.discordapp.com/attachments/917309676717244436/1039540436517257246/Backup_X_Accuracy.png)
...
:::::trainer[Ghost Marowak]
  :::pokemon[Marowak]
    ...
    ::damage[Marowak's Bonemerang(Per Hit)]{source="Squirtle" offensive=false movePower=50 level=37 evolution=2 opponentLevel=30 opponentStat=62 special=false stab=true type=ground}
  :::
:::::
...
:::::trainer[Rocket Grunt]
  ...
  :::pokemon[Golbat]
    - Water Pulse*
    :::if{source="Squirtle" condition="spatk=(x / x / 31)"}
    - Water Pulse is a 50% to OHKO without Torrent
    :::
    :::if{source="Squirtle" condition="spatk=(x / x / 28-30)"}
    - Water Pulse is a 37.5% to OHKO without Torrent
  :::
:::::
...
:::::trainer[Rocket Grunt]
  - Bite x3
  - Water Gun*/Water Pulse Raticate
  ::damage[Raticate's Quick Attack]{source="Squirtle" offensive=false movePower=40 level=38 evolution=2 opponentLevel=23 opponentStat=46 special=false stab=true type=normal}
:::::
...
:::::trainer[Leader Koga]
  ...
  :::pokemon[Muk]
    ...
    ::damage[Muk's Sludge]{source="Squirtle" offensive=false movePower=65 level=39 evolution=2 opponentLevel=39 opponentStat=77 combatStages=0 special=false stab=true type=poison}
  :::
  :::pokemon[Koffing]
    - Surf
  :::
  :::pokemon[Weezing]
    - Surf*
    - 37.5% to OHKO
    - Consider Bite + Surf if high hp or you want safety
    - Surf Turn 1 if +1 Torrent, Water Pulse + Surf if no Torrent on Weezing
    ::damage[Weezing's Sludge]{source="Squirtle" offensive=false movePower=65 level=40 evolution=2 opponentLevel=43 opponentStat=82 combatStages=0 special=false stab=true type=poison}
  :::
:::::
...
![](https://cdn.discordapp.com/attachments/917309676717244436/1094467178759213156/Carbos_Chart.png)

**Grab this Carbos if “Grab Carbos” on the chart above (Can bag manip the walker downstairs)**

![](https://cdn.discordapp.com/attachments/917309676717244436/1039546661275435109/Mansion_Carbos.png)

Grab this hidden Elixir

![](https://cdn.discordapp.com/attachments/917309676717244436/1039547193012527154/Mansion_Elixir.png)

Grab this TM14 (Blizzard) and then grab secret key on table

![](https://cdn.discordapp.com/attachments/917309676717244436/1039547192710545468/Mansion_Blizzard.png)
...
:::::trainer[Leader Blaine]
  :::pokemon[Growlithe]
    ...
    ::damage[Growlithe's Take Down]{source="Squirtle" offensive=false movePower=90 level=40 evolution=2 opponentLevel=42 statModifier=1.1 opponentStat=64 special=false stab=false type=normal}
    ::damage[Growlithe's Fire Blast]{source="Squirtle" offensive=false movePower=120 level=40 evolution=2 opponentLevel=42 opponentStat=63 special=true stab=true type=fire}
  :::
  :::pokemon[Ponyta]
    - Surf
  :::
  :::pokemon[Rapidash(22-23 Speed Ties)]
    - Surf
    ::damage[Rapidash's Bounce]{source="Squirtle" offensive=false movePower=85 level=41 evolution=2 opponentLevel=42 statModifier=1.1 opponentStat=80 special=false stab=false type=flying}
    ::damage[Rapidash's Fire Blast]{source="Squirtle" offensive=false movePower=120 level=41 evolution=2 opponentLevel=42 opponentStat=72 special=true stab=true type=fire}
  :::
  :::pokemon[Arcanine]
    - Surf*
...
Menu:-
- Teach Blizzard over Mega Kick(Slot 4)
- Rare Candy x2 to Level 44
- Heal if needed (preferably to high torrent)
...
:::::trainer[Leader Erika]
  :::pokemon[Victreebel]
    - Surf*/Blizzard
  ::damage[Victreebel's Giga Drain]{source="Squirtle" offensive=false movePower=60 level=44 evolution=2 opponentLevel=29 opponentStat=63 statModifier=1.1 special=true stab=true type=grass}
  :::
  :::pokemon[Tangela]
    - Bite
  :::
  :::pokemon[Vileplume]
    - Blizzard
  ::damage[Vileplume's Giga Drain]{source="Squirtle" offensive=false movePower=60 level=44 evolution=2 opponentLevel=29 opponentStat=63 statModifier=1.1 special=true stab=true type=grass}
  :::
:::::
...
Always bag manip the Rocket Spinner

On spinner bag manip
- Use the Max Elixir
- Use Carbos if you haven’t already
- Heal to around the HP below

:::if{source="Squirtle" condition="defense=(0-11 / x / x)"}
  - 82 HP
:::
:::if{source="Squirtle" condition="defense=(12-31 / 0-4 / x)"}
  - 80 HP
:::
:::if{source="Squirtle" condition="defense=(x / 5-25 / x)"}
  - 76 HP
:::
:::if{source="Squirtle" condition="defense=(x / 26-31 / x)"}
  - 74 HP
:::

:::::trainer[Rival 5]
  :::pokemon[Pidgeot]
    - X Special x2 + X Acc + Surf
    - Go to +2 SPA if Featherdance turn 1
    ::damage[Pidgeot's Wing Attack]{source="Squirtle" offensive=false movePower=60 level=44 evolution=2 opponentLevel=37 opponentStat=68 statModifier=1.1 special=false stab=true type=flying}
    ::damage[Pidgeot's Quick Attack]{source="Squirtle" offensive=false movePower=40 level=44 evolution=2 opponentLevel=37 opponentStat=68 statModifier=1.1 special=false stab=true type=normal}
  :::
  :::pokemon[Venusaur]
    - Blizzard
  :::
  :::pokemon[Gyarados]
    - Blizzard
    - Bite stall if not good enough torrent
  :::
  :::pokemon[Growlithe]
    - Bite
  :::
...
:::::trainer[Rocket Grunt]
  :::pokemon[Cubone]
    - Bite/Water Pulse
    ::damage[Cubone's Bonemerang(Per Hit)]{source="Squirtle" offensive=false movePower=50 level=45 evolution=2 opponentLevel=32 opponentStat=40 special=false stab=true type=ground}
    :::if{source="Squirtle" condition="spatk=(x / x / 28-29)"}
    - 75% to OHKO with Bite
    :::
    :::if{source="Squirtle" condition="spatk=(x / x / 30+)"}
    - 81.25% to OHKO with Bite
  :::
  :::pokemon[Drowzee]
    - Water Pulse
  :::
...
:::::trainer[Giovanni 2]
  ...
  :::pokemon[Kangaskhan]
    ...
    - 81.25% to 2HKO
    :::
    ::damage[Kangaskhan's Fake Out]{source="Squirtle" offensive=false movePower=40 level=46 evolution=2 opponentLevel=35 opponentStat=82 statModifier=1.1 special=false stab=true type=normal}
    ::damage[Kangaskhan's Mega Punch]{source="Squirtle" offensive=false movePower=80 level=46 evolution=2 opponentLevel=35 opponentStat=82 statModifier=1.1 special=false stab=true type=normal}
  :::
  :::pokemon[Rhyhorn]
    - Surf
  :::
...
:::::trainer[Leader Sabrina]
  :::pokemon[Kadabra]
    - Surf*
    - X Special if no torrent for Level 46 or 47
  :::
  :::pokemon[Mr. Mime]
    - Surf*
  :::
  ...
  ::damage[Venomoth's Psybeam]{source="Squirtle" offensive=false movePower=65 level=47 evolution=2 opponentLevel=38 opponentStat=65 statModifier=1.1 special=true stab=false type=psychic}
  :::
  :::pokemon[Alakazam]
    - Surf*
  :::
...
:::::trainer[Blackbelt Takashi]
  :::pokemon[Machoke]
    - Surf
    :::if{source="Squirtle" condition="spatk=(x / x / 28-29 )"}
    - 81.25% to OHKO first Machoke
    :::
    :::if{source="Squirtle" condition="spatk=(x / x / 30+ )"}
    - 87.5% to OHKO first Machoke
  :::
  :::pokemon[Machop]
    - Surf
  :::
...
:::::trainer[Leader Giovanni]
  ...
  :::pokemon[Dugtrio]
    - Water Pulse
    :::if{source="Squirtle" condition="speed=(x / 18-20 / x )"}
    - speed tie without Carbos
  :::
  :::pokemon[Nidoqueen]
    - Surf
  :::
...
:::::trainer[Rival 6]
  :::pokemon[Pidgeot]
    - X Special x2, (X Accuracy), Surf
    - Consider X Accuracy skip if you can live a Razor Leaf
    ::damage[Pidgeot's Wing Attack]{source="Squirtle" offensive=false movePower=60 level=49 evolution=2 opponentLevel=47 opponentStat=88 statModifier=1.1 special=false stab=true type=flying}
  :::
  :::pokemon[Venusaur]
    - Blizzard	 
    ::damage[Ivysaur's Razor Leaf]{source="Squirtle" offensive=false movePower=55 level=50 evolution=2 opponentLevel=53 opponentStat=126 statModifier=1.1 special=true stab=true type=grass}
  :::
  :::pokemon[Rhyhorn]
    - Bite
  :::
  :::pokemon[Gyarados]
    ...
    ::damage[Gyarados's Hydro Pump]{source="Squirtle" offensive=false movePower=120 level=50 evolution=2 opponentLevel=45 opponentStat=60 statModifier=1.1 special=true stab=true type=water}
  :::
  :::pokemon[Growlithe]
    - (X Speed,) Bite
  ...
  :::pokemon[Alakazam]
    - Surf 
    ::damage[Alakazam's Psychic]{source="Squirtle" offensive=false movePower=90 level=51 evolution=2 opponentLevel=47 opponentStat=140 statModifier=1.1 special=true stab=true type=psychic}
  :::
:::::

Wait to repel and yolo the grass after Rival (1% chance to encounter)

**Talk to Thunderbadge and Earthbadge guys**
...
**If doing risky Lorelei Switch to Normal Lorelei if Hail turn 1 or 2**

:::if{source="Squirtle" condition="$fight == 'Josh'"}
    Subtract 1 Defense IV to your squirtle to get accurate calcs of Lapras's Body Slam(increase it back after 
    fighting Lorelei)
:::

:::::trainer[Elite Four Lorelei(Risky)]
  :::pokemon[Dewgong]
    - X Special x2, Bite + Bite, X Special x2, Bite
    - She will not go for Hail if below half
    - 16% to knock into Heal Range
  :::
  :::pokemon[Cloyster]
    - Bite
  :::
  ...
  :::pokemon[Jynx]
    - Surf
    :::if{source="Squirtle" condition="speed=(x / 15-16 / x )"}
    - speed tie without Carbos
  :::
  :::pokemon[Lapras]
    - Bite x3
    ::damage[Lapras' Body Slam]{source="Squirtle" offensive=false movePower=85 level=52 evolution=2 opponentLevel=54 opponentStat=113 statModifier=1.1 special=false stab=false type=normal}
  :::
:::::

:::::trainer[Elite Four Lorelei(Normal)]
  :::pokemon[Dewgong]
    - X Special x4, Bite + Bite
...
**Do mid HP strat if 31 Speed + Carbos or 30 Speed + Carbos + 5 Spe IVs**

:::if{source="Squirtle" condition="$fight == 'Rocket'"}
    Subtract 1 Defense IV to your squirtle to get accurate calcs of all the Bruno fights(increase it back after 
    fighting Bruno)
:::
...
:::::trainer[Elite Four Bruno(High HP)]
  :::pokemon[Onix]
    - X Special x2, X Speed, Surf
    - Use an Extra X Special if missed Rock Tomb
    - Bite Both Onix at +3 or More
    ::damage[Onix's Earthquake]{source="Squirtle" offensive=false movePower=100 level=52 evolution=2 opponentLevel=51 opponentStat=66 statModifier=1.1 special=false stab=true type=ground} 
    ::damage[Onix's Rock Tomb]{source="Squirtle" offensive=false movePower=50 level=52 evolution=2 opponentLevel=51 opponentStat=66 statModifier=1.1 special=false stab=true type=rock}
    :::if{source="Squirtle" condition="speed=(x / 31 / x )"}
    - outspeed onix at -1 
  :::
  :::pokemon[Hitmonchan]
    -  Surf*
    ::damage[Hitmonchan's Mach Punch]{source="Squirtle" offensive=false movePower=40 level=52 evolution=2 opponentLevel=53 opponentStat=132 statModifier=1.1 special=false stab=true type=fighting} 
    ::damage[Hitmonchan's Sky Uppercut]{source="Squirtle" offensive=false movePower=85 level=52 evolution=2 opponentLevel=53 opponentStat=132 statModifier=1.1 special=false stab=true type=fighting}
    ::damage[Hitmonchan's Rock Tomb]{source="Squirtle" offensive=false movePower=50 level=52 evolution=2 opponentLevel=53 opponentStat=132 statModifier=1.1 special=false stab=false type=rock}
  :::
  :::pokemon[Hitmonlee]
    -  Surf*
  :::
...
:::::trainer[Elite Four Bruno(Mid HP)]
  :::pokemon[Onix]
    - Guard Spec., X Special x2, Surf
  ...
  :::pokemon[Hitmonlee]
    -  Surf*
    :::if{source="Squirtle" condition="speed=(x / 17-18 / x)"}
    - Speed Tie Unless Carbos
  :::
  :::pokemon[Machamp]
    -  Surf*
...
:::::trainer[Elite Four Bruno(Low HP)]
  :::pokemon[Onix]
    - Full Restore, X Special x2, X Speed, Surf
    - Use an Extra X Special if missed Rock Tomb
    - Bite Both Onix at +3 or More
    ::damage[Onix's Earthquake]{source="Squirtle" offensive=false movePower=100 level=52 evolution=2 opponentLevel=51 opponentStat=66 statModifier=1.1 special=false stab=true type=ground} 
    :::damage[Onix's Rock Tomb]{source="Squirtle" offensive=false movePower=50 level=52 evolution=2 opponentLevel=51 opponentStat=66 statModifier=1.1 special=false stab=true type=rock}
...
:::if{source="Squirtle" condition="$fight == 'Josh'"}
    Subtract 1 Defense IV to your squirtle to get accurate calcs of Gengar's Shadow Punch(increase it back after 
    fighting Agatha)
:::
...
:::::trainer[Elite Four Agatha]
  :::pokemon[Gengar]
    ...
    ::damage[Gengar's Shadow Punch]{source="Squirtle" offensive=false movePower=60 level=53 evolution=2 opponentLevel=54 opponentStat=100 statModifier=1.1 special=false stab=true type=ghost}
  :::
  :::pokemon[Golbat]
    - Surf*
  :::
...
Lance Dragon Rage x2 Hyper Beam Chart

![](https://cdn.discordapp.com/attachments/917309676717244436/1039799649369858119/Gyara_Dead_Chart.png)

:::::trainer[Elite Four Lance(Safe Lance)]
  :::pokemon[Gyarados]
    - Bite, X Accuracy, X Special, Blizzard + Blizzard
    :::if{source="Squirtle" condition="spatk=(x / x / 30 )"}
    - 31.25% to 2HKO with Blizzard
    :::
    :::if{source="Squirtle" condition="spatk=(x / x / 31 )"}
    - 41.8% to 2HKO with Blizzard
    ::damage[Gyarados' Hyper Beam ]{source="Squirtle" offensive=false movePower=150 level=54 evolution=2 opponentLevel=56 opponentStat=161 statModifier=1.1 special=false stab=false type=normal}
  :::
  :::pokemon[Dragonair]
    - Blizzard
  ...
  :::pokemon[Aerodactyl]
    - Blizzard
    - If Ancient Power Boost, either spam Surf or Heal + go for the range
    - 37.5% to ohko if Ancient Power boost + no Torrent, guaranteed /w Torrent
    ::damage[Aerodactyl's Hyper Beam]{source="Squirtle" offensive=false movePower=150 level=55 evolution=2 opponentLevel=58 opponentStat=129 statModifier=1.1 special=false stab=false type=normal}
  :::
:::::

**Consider Risky Lance if 2 Dragon Rages puts you into Hyper Beam range**

:::::trainer[Elite Four Lance(Risky Lance)]
  :::pokemon[Gyarados]
    - X Special, Bite x2, X Accuracy, Blizzard
    ::damage[Gyarados' Hyper Beam ]{source="Squirtle" offensive=false movePower=150 level=54 evolution=2 opponentLevel=56 opponentStat=161 statModifier=1.1 special=false stab=false type=normal}
    :::if{source="Squirtle" condition="spatk=(x / x / 31 )"}
    - 85% to 3HKO 
    :::
    ...
    :::
    :::if{source="Squirtle" condition="spatk=(x / x / 31 )"}
    - 83% to 2HKO with Bite Crit+Blizzard
    :::
    :::if{source="Squirtle" condition="spatk=(x / x / 28-30 )"}
    - 72% to 2HKO with Bite Crit+Blizzard
  :::
  :::pokemon[Dragonair]
    - Blizzard
    - Dragonair Hyper Beam does 45-66
...
:::::trainer[Champion]
  :::pokemon[Pidgeot]
    - Guard Spec, X Speed, X Special x2(x3), Surf
    ...
    ::damage[Pidgeot's Aerial Ace]{source="Squirtle" offensive=false movePower=60 level=55 evolution=2 opponentLevel=59 opponentStat=117 statModifier=1.1 special=false stab=true type=flying}
  :::
  :::pokemon[Venusaur]
    - X Accuracy + Blizzard at +2
    - Bite + Surf* at +3
  ...
  :::pokemon[Gyarados]
    - Bite + Blizzard at +3
    - Blizzard x2 at +2
    ::damage[Gyarados's Thrash]{source="Squirtle" offensive=false movePower=90 level=56 evolution=2 opponentLevel=59 opponentStat=153 statModifier=1.1 special=false stab=false type=normal}
  :::
  :::pokemon[Arcanine]
    - Surf
    ::damage[Arcanine's Extremespeed]{source="Squirtle" offensive=false movePower=80 level=56 evolution=2 opponentLevel=61 opponentStat=158 statModifier=1.1 special=false stab=false type=normal}
:::::
