:::tracker{species="Squirtle" baseStats="[[44, 48, 65, 50, 64, 43], [59, 63, 80, 65, 80, 58], [79, 83, 100, 85, 105, 78]]" type="Water" generation=3 directInput=true}
  5:
    ...
    44 ->	19, 27, 63, 23, 8, 56
    45 ->	19, 29, 47, 28, 9, 59
    46 ->	19, 32, 50, 31, 10, 59
    47 ->	24, 32, 51, 33, 12, 59
    48 ->	24, 37, 53, 37, 12, 60
    49 ->	29, 37, 57, 37, 12, 62
    50 ->	32, 40, 58, 39, 13, 65
    51 ->	32, 43, 59, 42, 13, 65
    52 ->	32, 43, 63, 44, 15, 65
    53 ->	34, 48, 64, 44, 17, 65
    54 ->	34, 50, 65, 50, 17, 67
    55 ->	34, 59, 65, 52, 17, 67
    56 ->	34, 59, 65, 54, 18, 72
    57 ->	34, 63, 67, 57, 18, 72
:::

## Pokémon FireRed/LeafGreen Any%(Beginner/Hiker Nob) Route
...
Kill any level 2 or 3 Pidgey/Rattata along the way
  ...
  - If you don't kill anything on route 1 can kill a Level 3 caterpie but you need to switch to High Exp route in case you do not fight Josh or Rocket Grunt
...
Fight the Hiker below instead of the Youngster above
...
*Grab this hidden Ether (Risky but can skip if Torrent at 27 + 2 MKs left)*
...
:::::trainer[Camper Jeff]
  ...
  :::pokemon[Raticate]
    ...
    ::damage[Raticate's Quick Attack]{source="Squirtle" offensive=false movePower=40 level=27 evolution=1 opponentLevel=16 opponentStat=30 special=false stab=true type=normal}
  :::
:::::
...
- Make sure to use Candy before fighting Gentleman if did not used it before Rival
...
:::::trainer[Rocket Grunt]
  ...
  ::damage[Raticate's Quick Attack]{source="Squirtle" offensive=false movePower=40 level=40 evolution=2 opponentLevel=23 opponentStat=46 special=false stab=true type=normal}
:::::
...
:::::trainer[Juggler Kirk]
  - Surf* x4
  - X Special turn 1 if no Torrent at 39/40
:::::
...
![](https://cdn.discordapp.com/attachments/917309676717244436/1042705897610301451/Carbos_Chart.png)
...
:::::trainer[Leader Blaine]
  :::pokemon[Growlithe]
    - (X-Speed,) Surf
    - X Speed at 17-24 Speed, only X-Speed at 25 if you skipped the Carbos
...
![](https://cdn.discordapp.com/attachments/917309676717244436/1042720352658280508/Gyara_Dead_Chart.png)

:::::trainer[Elite Four Lance(Risky Lance)]
  :::pokemon[Gyarados]
    - X Accuracy, X Special, Bite x2, Blizzard
    - Blizzard Immediately if Turn 1 Crit Bite
    :::if{source="Squirtle" condition="spatk=(x / x / 30 )"}
    - 85% to 3HKO
    :::
    :::if{source="Squirtle" condition="spatk=(x / x / 31 )"}
